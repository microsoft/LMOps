...
def init_predefined_dispatch_mode():
    ...
    Dispatch.register("SHUFFLE_DP_COMPUTE_PROTO")
...
def dispatch_shuffle_dp_compute_data_proto(worker_group, *args, **kwargs):
    from verl.single_controller.base.worker_group import WorkerGroup
    assert isinstance(worker_group, WorkerGroup)
    splitted_args, splitted_kwargs = _shuffle_args_kwargs_data_proto(worker_group.world_size, *args, **kwargs)
    return splitted_args, splitted_kwargs
...
def collect_shuffle_dp_compute_data_proto(worker_group, output):
    from verl.protocol import DataProto
    import ray
    ...
    output = collect_dp_compute(worker_group, output)
    data_proto = _concat_data_proto_or_future(output)
    _sort_data_proto_to_original_order(data_proto)
    return data_proto
...
DISPATCH_MODE_FN_REGISTRY = {
    ...
    Dispatch.SHUFFLE_DP_COMPUTE_PROTO: {
        'dispatch_fn': dispatch_shuffle_dp_compute_data_proto,
        'collect_fn': collect_shuffle_dp_compute_data_proto
    }
}
