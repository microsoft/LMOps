...
TYPE="eval_lm"
# model
CKPT_NAME="1B-sgd100-160M-10k-lima-t0.1-r0.4"
CKPT="${BASE_PATH}/results/pretrain/cc-sgd100-160M-10k-lima-t0.1-r0.4/mistral_1B/t100K-w2K-bs8-lr0.0002.5cosine2.5e-05-G4-N16-NN2-scr"
# data
DATA_NAME="dclm"
# hp
EVAL_BATCH_SIZE=64
