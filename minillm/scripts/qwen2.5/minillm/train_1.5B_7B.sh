...
CKPT_NAME="1.5B-init"
CKPT="/PATH/TO/1.5B/init"
TEACHER_CKPT_NAME="7B-sft"
TEACHER_CKPT="/PATH/TO/7B/sft"
MP_SIZE=4
# data
PROMPT_DATA_DIR="${BASE_PATH}/processed_data/dolly/prompt/qwen2/"
LM_DATA_DIR="/PATH/TO/LM/DATA"
# runtime
SAVE_PATH="${BASE_PATH}/results/qwen2/train/minillm/"
# hp
GRAD_ACC=2
BATCH_SIZE=8
CHUNK_SIZE=8
