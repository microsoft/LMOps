...
class DataProto:
    ...
    def slice(self, start=None, end=None, step=None):
        ...
        return type(self)(batch=sliced_batch, non_tensor_batch=sliced_non_tensor, meta_info=self.meta_info.copy())
    ...
    def concat(data: List["DataProto"]) -> "DataProto":
        ...
        return cls(batch=new_batch, non_tensor_batch=non_tensor_batch, meta_info=data[0].meta_info.copy())
