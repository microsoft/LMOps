...
if [ "$#" -gt 0 ]; then
    ...
    EXPERIMENTS=(
        "sokoban-q3-4b-ins-lr5e-6,2,50,2,Qwen/Qwen3-4B-Instruct-2507,false,1024,Sokoban-v0,5,true"
        "frozenlake-q3-1b7-think-lr5e-6,2,50,2,Qwen/Qwen3-1.7B,false,1024,FrozenLake-v0-raw,5,false"
    )
fi
